<template>
  <div id="app">
    <div id="nav">
      ...
      <router-link to="/scenario1">Components communication</router-link> |
      ...
      <router-link to="/challenge4">Challenge4</router-link> ||
      <router-link to="/challenge5">Challenge5</router-link>
    </div>
    <router-view />
  </div>
</template>
